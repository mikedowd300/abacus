This project creates a virtual abacus with two modes. In "demo mode" there are tutorials for its use in addition, subtraction, multiplication and division.

In "challenge mode" there are levels of difficulty for addtion, addition with subtraction, multiplication and division. The initial problems will be simple, but as the user solves each problem the subsequent ones become incrementally harder.
